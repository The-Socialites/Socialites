...
export const Header77Defaults: Header77Props = {
    heading: "Discover and Experience Local Events with Us",
    description:
        "Welcome to our event management and ticketing service. Browse, create, and promote local events hassle-free.",
